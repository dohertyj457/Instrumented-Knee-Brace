...
void recordAccel1(int sensor){
  ...
  allData[1] = int(aX / 16384);
  allData[2] = int(aY / 16384);
  allData[3] = int(aZ / 16384);
}
...
void recordGyro1(int sensor){
  ...
  allData[4] = int(gyroX / 131);
  allData[5] = int(gyroY / 131);
  allData[6] = int(gyroZ / 131);
...
void recordAccel2(int sensor){
  ...
  // Must be processed: based on Accelerometer register settings
  allData[8] = int(aX / 16384);
  allData[9] = int(aY / 16384);
  allData[10] = int(aZ / 16384);
}
...
void recordGyro2(int sensor){
  ...
  allData[11] = int(gyroX / 131);
  allData[12] = int(gyroY / 131);
  allData[13] = int(gyroZ / 131);
...
void writeIMU(){
  ...
  // myFile.print(gyroX1); myFile.print(","); myFile.print(gyroY1); myFile.print(","); myFile.print(gyroZ1); myFile.print(","); 
  // myFile.print(aX1); myFile.print(","); myFile.print(aY1); myFile.print(","); myFile.print(aZ1); myFile.print(","); 
  // myFile.print(gyroX2); myFile.print(","); myFile.print(gyroY2); myFile.print(","); myFile.print(gyroZ2); myFile.print(",");
  // myFile.print(aX2); myFile.print(","); myFile.print(aY2); myFile.print(","); myFile.println(aZ2);// this may need to be adjusted when printing more than one signal 
  // //close the file:
  myFile.close();
  }
  else {
